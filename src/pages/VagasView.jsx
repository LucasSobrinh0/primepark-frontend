...
const VagasView = () => {
  ...
  const fetchVagas = async () => {
    try {
      setLoading(true);
      const response = await fetch(`${process.env.REACT_APP_API_URL}/api/vagas/vaga/`);
      if (response.ok) {
  ...
  const handleDelete = async (vagaId) => {
    ...
    try {
      const response = await fetch(`${process.env.REACT_APP_API_URL}/api/vagas/vaga/${vagaId}/`, {
        method: 'DELETE',
      });
      if (response.ok) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (editingVaga) {
        ...
        response = await fetch(`${process.env.REACT_APP_API_URL}/api/vagas/vaga/${editingVaga.id}/`, {
          method: 'PATCH',
        ...
        response = await fetch(`${process.env.REACT_APP_API_URL}/api/vagas/vaga/`, {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
          body: JSON.stringify(payload)
        });
